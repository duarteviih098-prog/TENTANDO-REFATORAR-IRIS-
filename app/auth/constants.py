...
TENANT_TABLES = {'users','bombas','combustivel','pagamentos','custos','os_ativos','os_ordens','email_history','email_monitor_events','email_test_history','email_monitor_test_runs','recebimentos'}
